...
export class DateRangeSearchComponent implements OnInit {
  ...
  updateDateRangeTypeAction: SoctopusActionTypes;
  ...
  calculateDate(dateRangeType: DateRangeSelectionType): void {
    ...
    switch(dateRangeType){
      ...
      case(DateRangeSelectionType.LAST_3_MONTHS):{
        startDate.setMonth(startDate.getMonth() - 3);
        this.btnSelected = 4;
        break;
      }
      case(DateRangeSelectionType.LAST_6_MONTHS):{
        startDate.setMonth(startDate.getMonth() - 6);
        this.btnSelected = 5;
        break;
      }
      case(DateRangeSelectionType.LAST_12_MONTHS):{
